...
\author[inst1]{Qiyang Zhang}
\author[inst1]{Zhuang Miao\corref{cor1}}
\author[inst1]{Yang Li\corref{cor1}}
\author[inst1]{Haoyu Li}
\author[inst1]{Zhigang Li}

\cortext[cor1]{Corresponding authors. E-mails: emiao\_beyond@163.com (Z. Miao), solarleeon@outlook.com (Y. Li).}

\affiliation[inst1]{organization={School of Command and Control Engineering, Army Engineering University of PLA},
city={Nanjing},
country={China}}
...
The source code is available at: \url{https://github.com/Austin98/PPAIN}
